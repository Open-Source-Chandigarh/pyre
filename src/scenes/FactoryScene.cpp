...
FactoryScene::FactoryScene() : shader(nullptr), rotationAngle(0.0f), rotationSpeed(50.0f)
{
...
void FactoryScene::Init(AppState &appState)
{
    ...
    diffuseMap = ResourceManager::LoadTexture("resources/textures/metalDiff.png", TextureType::TEX_DIFFUSE);
    specularMap = ResourceManager::LoadTexture("resources/textures/metalSpec.png", TextureType::TEX_SPECULAR);

    ResourceManager::LoadShader("skybox", "shaders/common/skyBox.vs", "shaders/common/skyBox.fs");

    std::vector<std::string> faces = {
        "resources/textures/stylizedSky/front.png", "resources/textures/stylizedSky/back.png",
        "resources/textures/stylizedSky/top.png",   "resources/textures/stylizedSky/bottom.png",
        "resources/textures/stylizedSky/right.png", "resources/textures/stylizedSky/left.png",
    };
...
void FactoryScene::OnActivate(AppState &appState)
{
    ...
    appState.lightManager->SetDirectional(glm::vec3(-0.5f, -1.0f, -0.5f), glm::vec3(0.05f),
                                          glm::vec3(0.1f, 0.15f, 0.3f), glm::vec3(0.2f));
...
void FactoryScene::Update(AppState &appState)
{
    ...
    {
        if (entities[i]->skyboxComp)
            continue; // Skip skybox
