...
template <typename ExceptionType = DeadlyImportError> inline ai_real fast_atof(const char *c)
{
    ai_real ret(0.0);
...
template <typename ExceptionType = DeadlyImportError> inline ai_real fast_atof(const char *c, const char **cout)
{
    ai_real ret(0.0);
...
template <typename ExceptionType = DeadlyImportError> inline ai_real fast_atof(const char **inout)
{
    ai_real ret(0.0);
